...
def opt_350m():
    ...
    opt_config = AutoConfig.from_pretrained('/datasets/models/OPT-350M')
    return OPTLMModel(opt_config)


def opt_1b():
    # opt_config = AutoConfig.from_pretrained('facebook/opt-1.3b')
    opt_config = AutoConfig.from_pretrained('/datasets/models/OPT-1.3B')
    return OPTLMModel(opt_config)


def opt_3b():
    # opt_config = AutoConfig.from_pretrained('facebook/opt-2.7b')
    opt_config = AutoConfig.from_pretrained('/datasets/models/OPT-2.7B')
    return OPTLMModel(opt_config)


def opt_7b():
    # opt_config = AutoConfig.from_pretrained('facebook/opt-6.7b')
    opt_config = AutoConfig.from_pretrained('/datasets/models/OPT-6.7B')
    return OPTLMModel(opt_config)


def opt_13b():
    # opt_config = AutoConfig.from_pretrained('facebook/opt-13b')
    opt_config = AutoConfig.from_pretrained('/datasets/models/OPT-13B')
    return OPTLMModel(opt_config)


def opt_30b():
    # opt_config = AutoConfig.from_pretrained('facebook/opt-30b')
    opt_config = AutoConfig.from_pretrained('/datasets/models/OPT-30B')
    return OPTLMModel(opt_config)


def opt_66b():
    # opt_config = AutoConfig.from_pretrained('facebook/opt-66b')
    opt_config = AutoConfig.from_pretrained('/datasets/models/OPT-66B')
    return OPTLMModel(opt_config)
